    ...
    <form method="POST" action="{{route('page.store')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" id="title" autocomplete="title" placeholder="Type title" class="form-control @error('title')
                    is-invalid
                @enderror"  value="{{ $pages->title }}" required aria-describedby="nameHelp">
        ...
        <div class="form-group">
            ...
            is-invalid
            @enderror"
            value="{{ $pages->description }}" required aria-describedby="nameHelp">{{ old('description') }}</textarea>
        ...
        <div class="row align-items-start">
            <div class="col">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" name="is_active" id="is_active" value="{{$pages->is_active}}">
            ...
            <div class="col">
                <div class="form-group"> <!-----image----->
                    ...
                    class="form-control @error('name')
                            is-invalid
                        @enderror"
                    value="{{ $pages->image }}"  aria-describedby="nameHelp">
